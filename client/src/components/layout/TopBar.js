...
const TopBar = ({ logout }, context) => (
  <div>
    <nav>
      <Link className='brand' to='/'><img alt="" src='https://cdn4.iconfinder.com/data/icons/proglyphs-free/512/Invader_1-512.png' width='50px'></img> Game Teca</Link>
      ...
      <div className='menu'>
        ...
        <Link className='pseudo button' to='/games'>Jogos</Link>
        {
